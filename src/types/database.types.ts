		...
		Tables: {
			...
			contracts: {
				Row: {
					...
					annual_consumption_kwh: number | null;
					energy_price_eur: number | null;
					power_price_p1_eur: number | null;
					power_price_p2_eur: number | null;
					power_price_p3_eur: number | null;
					power_price_p4_eur: number | null;
					power_price_p5_eur: number | null;
					power_price_p6_eur: number | null;
